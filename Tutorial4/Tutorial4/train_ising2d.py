...
T  = 1.0000 #a temperature for which there are MC configurations stored in data_ising2d/MC_results_solutions 
...
trainFileName = 'data_ising2d/MC_results_solutions/ising2d_L%d_T%.4f.txt' %(L,T)
